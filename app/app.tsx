...
const UserList = lazyWithRetry(() => import('@/components/UserList').then((module) => ({ default: module.UserList })));
const UserForm = lazyWithRetry(() => import('@/components/UserForm').then((module) => ({ default: module.UserForm })));
const SetPasswordForm = lazyWithRetry(() => import('@/components/SetPasswordForm').then((module) => ({ default: module.SetPasswordForm })));
const ClienteList = lazyWithRetry(() => import('@/components/ClienteList').then((module) => ({ default: module.ClienteList })));
const ClienteForm = lazyWithRetry(() => import('@/components/ClienteForm').then((module) => ({ default: module.ClienteForm })));
const EmpresaList = lazyWithRetry(() => import('@/components/EmpresaList').then((module) => ({ default: module.EmpresaList })));
const GrupoList = lazyWithRetry(() => import('@/components/GrupoList').then((module) => ({ default: module.GrupoList })));
const FornecedorList = lazyWithRetry(() => import('@/components/FornecedorList').then((module) => ({ default: module.FornecedorList })));
const ContaList = lazyWithRetry(() => import('@/components/ContaList').then((module) => ({ default: module.ContaList })));
const GrupoContabilList = lazyWithRetry(() => import('@/components/GrupoContabilList').then((module) => ({ default: module.GrupoContabilList })));
const SubgrupoContabilList = lazyWithRetry(() => import('@/components/SubgrupoContabilList').then((module) => ({ default: module.SubgrupoContabilList })));
const ProductList = lazyWithRetry(() => import('@/components/ProductList').then((module) => ({ default: module.ProductList })));
const TipoDocumentoList = lazyWithRetry(() => import('@/components/TipoDocumentoList').then((module) => ({ default: module.TipoDocumentoList })));
...
const ExtratosList = lazyWithRetry(() => import('@/components/ExtratosList').then((module) => ({ default: module.ExtratosList })));
const RelatorioCliente = lazyWithRetry(() => import('@/components/RelatorioCliente').then((module) => ({ default: module.RelatorioCliente })));
