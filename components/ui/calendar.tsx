...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      classNames={{
        root: cn("w-[218px] min-w-[218px]", defaultClassNames.root),
        months: cn("relative flex flex-col gap-2 md:flex-row", defaultClassNames.months),
        month: cn("flex h-[280px] w-full flex-col gap-2", defaultClassNames.month),
        ...
        range_start: cn("bg-slate-100 rounded-l-lg", defaultClassNames.range_start),
